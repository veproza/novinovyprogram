...
const publications: Publication[] = ['idnes', 'lidovky', 'aktualne', 'irozhlas', 'novinky', 'ihned', 'denik', 'denikn', 'bbc', 'ft', 'lemonde', 'wyborcza', 'spiegel', 'seznamzpravy'];
...
const addFileToResult = async (file: FileAndDate, publication: PublicationDay): Promise<void> => {
    ...
    try {
        ...
        if(publication.print === undefined) {
            const timeToGetTitulka = publicationId === 'denik' ? 8 : 6;
